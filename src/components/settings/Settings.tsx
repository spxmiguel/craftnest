      ...
      <div className="space-y-4">
        <div className="p-4 bg-surface-800 border border-surface-700 rounded-xl">
          ...
          <input
            ...
            className="w-full bg-surface-700 border border-surface-600 rounded-xl px-4 py-2.5 text-sm text-white placeholder-zinc-600 focus:outline-none focus:border-brand-500 font-mono"
          />
