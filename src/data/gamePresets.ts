...
export const GAME_PRESETS: GamePreset[] = [
  ...
  // ── 🌿 Survival Padrão ──────────────────────────────────────────────────────
  {
    ...
    readyToPlay: true,
    featuresPT: ['Mundo gerado automaticamente', 'Proteção de terreno (claim)', 'Chat com cores e ranks', 'Log de ações (CoreProtect)', 'Anti-cheat básico'],
    featuresEN: ['Auto-generated world', 'Land claim protection', 'Colored chat with ranks', 'Action log (CoreProtect)', 'Basic anti-cheat'],
    plugins: [P.spark, P.luckPerms, P.vault, P.papi, P.viaVersion, P.tab, P.griefPrev, P.coreProtect, P.chairs],
  ...
  // ── 💀 Hardcore ─────────────────────────────────────────────────────────────
  {
    ...
    readyToPlay: true,
    featuresPT: ['Morte permanente (vira espectador)', 'Dificuldade hard fixa', 'Vida reduzida por fome', 'Log de ações (CoreProtect)', 'Sem respawn'],
    featuresEN: ['Permanent death (becomes spectator)', 'Fixed hard difficulty', 'Starvation damage', 'Action log (CoreProtect)', 'No respawn'],
    plugins: [P.spark, P.luckPerms, P.vault, P.papi, P.viaVersion, P.tab, P.coreProtect],
  ...
  // ── 🏝️ Skyblock ──────────────────────────────────────────────────────────────
  {
    ...
    plugins: [P.spark, P.luckPerms, P.vault, P.papi, P.viaVersion, P.tab, P.decentHolo, P.bentoBox, P.bSkyBlock, P.levelAddon, P.challenges, P.warps],
  ...
  // ── ⬛ OneBlock ───────────────────────────────────────────────────────────────
  {
    ...
    plugins: [P.spark, P.luckPerms, P.vault, P.papi, P.viaVersion, P.tab, P.decentHolo, P.bentoBox, P.aOneBlock, P.levelAddon, P.challenges],
  ...
  // ── 💰 Ilha com Economia (ReiDeSky) ──────────────────────────────────────────
  {
    ...
    plugins: [P.spark, P.luckPerms, P.vault, P.papi, P.viaVersion, P.tab, P.decentHolo, P.bentoBox, P.bSkyBlock, P.levelAddon, P.challenges, P.bankAddon, P.warps, P.mcMMO, P.jobs],
  ...
  // ── 🥊 KitPvP ────────────────────────────────────────────────────────────────
  {
    ...
    readyToPlay: true,
    featuresPT: ['Kits: Guerreiro, Arqueiro, Mago, Tank', '/kit para equipar na hora', 'Mundo plano pronto para lutar', 'Anti-combatlog', 'LuckPerms + ViaVersion'],
    featuresEN: ['Kits: Warrior, Archer, Mage, Tank', '/kit to equip instantly', 'Flat world ready to fight', 'Anti-combatlog', 'LuckPerms + ViaVersion'],
    plugins: [P.spark, P.luckPerms, P.vault, P.papi, P.viaVersion, P.tab, P.decentHolo, P.combatLog, P.protocolLib],
