...
const P = {
  ...
  // Minigame plugins
  bedWars:        { name: 'BedWars1058',        filename: 'BedWars1058.jar',         url: 'https://github.com/andross136/Andross-BedWars/releases/latest/download/BedWars1058.jar' },
  skyWarsR:       { name: 'SkyWarsReloaded',    filename: 'SkyWarsReloaded.jar',     url: 'https://github.com/lukesky19/SkyWarsReloaded/releases/latest/download/SkyWarsReloaded.jar' },
  kitPvP:         { name: 'UltraKits',          filename: 'UltraKits.jar',           url: 'https://github.com/TheViperShow/UltraKits/releases/latest/download/UltraKits.jar' },
  nkitPvP:        { name: 'NewKitPvP',          filename: 'NewKitPvP.jar',           url: 'https://github.com/Hazork/NewKitPvP/releases/latest/download/NewKitPvP.jar' },
  voidGen:        { name: 'VoidGen',            filename: 'VoidGen.jar',             url: 'https://github.com/jonkadelic/VoidGenerator/releases/latest/download/VoidGen.jar' },
  scoreBoard:     { name: 'AnimatedScoreboard', filename: 'AnimatedScoreboard.jar',  url: 'https://github.com/Dreeam-qwq/Scoreboard-revision/releases/latest/download/Scoreboard-revision.jar' },
  ...
  npc:            { name: 'ZNPCS',              filename: 'znpcs.jar',               url: 'https://github.com/nickuc/OpeNLogin/releases/latest/download/OpeNLogin.jar' },
}
...
export const GAME_PRESETS: GamePreset[] = [
  ...
  // ── 💰 Ilha com Economia (ReiDeSky) ──────────────────────────────────────────
  {
    ...
    descPT: 'Skyblock completo com sistema econômico real: loja de compra/venda, empregos com salário, banco da ilha, hologramas de ranking e muito mais — estilo ReiDeSky.',
    descEN: 'Full Skyblock with real economy: buy/sell shop, salaried jobs, island bank, ranking holograms and much more — ReiDeSky style.',
    color: 'text-amber-300', border: 'border-amber-500/30', bg: 'bg-amber-500/10', glow: 'shadow-amber-500/15',
    gradient: 'from-amber-500/20 to-transparent',
    players: '5–100', difficultyPT: 'Médio — configure preços da loja', difficultyEN: 'Medium — configure shop prices',
    readyToPlay: false,
    featuresPT: ['Loja de compra/venda de itens', 'Empregos (mineração, corte, pesca)', 'Banco da ilha com depósitos', 'Ranking de riqueza e nível', 'Missões e desafios com recompensas'],
    featuresEN: ['Item buy/sell shop', 'Jobs (mining, cutting, fishing)', 'Island bank with deposits', 'Wealth and level ranking', 'Missions and challenges with rewards'],
    ...
    worldNotePT: 'Configure os preços da loja em plugins/Shop/config.yml após iniciar o servidor.',
    worldNoteEN: 'Configure shop prices in plugins/Shop/config.yml after starting the server.',
  },
  ...
  // ── 🥊 KitPvP ────────────────────────────────────────────────────────────────
  {
    ...
    descPT: 'Servidor de PvP competitivo com kits pré-configurados (Guerreiro, Arqueiro, Mago, Tank), ranking de kills/mortes e arenas planas prontas para jogar.',
    descEN: 'Competitive PvP server with pre-configured kits (Warrior, Archer, Mage, Tank), kills/deaths ranking and flat arenas ready to play.',
    color: 'text-orange-300', border: 'border-orange-500/30', bg: 'bg-orange-500/10', glow: 'shadow-orange-500/15',
    gradient: 'from-orange-500/20 to-transparent',
    players: '2–32', difficultyPT: 'Fácil — kits configurados', difficultyEN: 'Easy — pre-configured kits',
    readyToPlay: true,
    featuresPT: ['Kits: Guerreiro, Arqueiro, Mago, Tank', 'Ranking de kills/mortes', 'Arena plana gerada automaticamente', 'Anti-combatlog', 'Kill streaks e recompensas'],
    featuresEN: ['Kits: Warrior, Archer, Mage, Tank', 'Kills/deaths ranking', 'Auto-generated flat arena', 'Anti-combatlog', 'Kill streaks and rewards'],
    plugins: [P.spark, P.luckPerms, P.vault, P.papi, P.viaVersion, P.tab, P.decentHolo, P.essentialsX, P.combatLog, P.protocolLib, P.kitPvP],
    serverProperties: { difficulty: 'normal', pvp: true, 'max-players': 32, 'level-type': 'flat', 'allow-nether': false },
  },
  ...
  // ── 🛏️ BedWars ───────────────────────────────────────────────────────────────
  {
    ...
    gradient: 'from-red-500/20 to-transparent',
    players: '2–16', difficultyPT: 'Médio — registre as arenas', difficultyEN: 'Medium — register arenas',
    readyToPlay: false,
    ...
    worldNotePT: 'Após iniciar, use /bw setup para criar e registrar as arenas. Tutorial: https://github.com/andross136/Andross-BedWars/wiki',
    worldNoteEN: 'After starting, use /bw setup to create and register arenas. Tutorial: https://github.com/andross136/Andross-BedWars/wiki',
  },
  ...
  // ── 🌌 SkyWars ───────────────────────────────────────────────────────────────
  {
    ...
    descPT: 'Cada jogador começa em uma ilha no céu com um baú cheio de itens. O objetivo: sobreviver e eliminar todos os outros. O último vence.',
    descEN: 'Each player starts on a sky island with a chest full of items. The goal: survive and eliminate everyone else. Last one wins.',
    color: 'text-violet-300', border: 'border-violet-500/30', bg: 'bg-violet-500/10', glow: 'shadow-violet-500/15',
    gradient: 'from-violet-500/20 to-transparent',
    players: '4–24', difficultyPT: 'Médio — registre os mapas', difficultyEN: 'Medium — register maps',
    readyToPlay: false,
    featuresPT: ['Ilhas únicas por jogador', 'Baús com loot aleatório por tier', 'Kits desbloqueáveis', 'Votação de mapa', 'Ranking e estatísticas'],
    featuresEN: ['Unique island per player', 'Chests with random tier loot', 'Unlockable kits', 'Map voting', 'Ranking and statistics'],
    plugins: [P.spark, P.luckPerms, P.vault, P.papi, P.viaVersion, P.tab, P.decentHolo, P.protocolLib, P.skyWarsR, P.multiverse],
    serverProperties: { difficulty: 'normal', pvp: true, 'max-players': 24, 'allow-nether': false, 'allow-end': false },
    worldNotePT: 'Após iniciar, use /sw create para criar mapas de arena. Tutorial: https://github.com/lukesky19/SkyWarsReloaded/wiki',
    worldNoteEN: 'After starting, use /sw create to create arena maps. Tutorial: https://github.com/lukesky19/SkyWarsReloaded/wiki',
  },
]
